                        ...
                        <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                            <div>
                                <div className="flex items-center">
                                    <svg className="h-6 w-6 text-gray-600 mr-2" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor">
                                ...
                                <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                    <div
                                        ...
                                        <label htmlFor="application_name"
                                               className="block text-gray-700 text-sm font-bold mb-2 sm:mt-px sm:pt-2">
                                            Application Name
                                        </label>
