...
func (_m *MockMigrator) AcquireMigrationLock() (bool, error) {
	ret := _m.Called()
...
func (_m *MockMigrator) ReleaseMigrationLock() error {
	ret := _m.Called()
...
// NewMigrator creates a new instance of MockMigrator. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
